...
export const BENCHMARK_DATASETS = [
  {
    id: 'DS-EXTRANOM',
    name: 'ExtrAnom (Women-Safety Stalking & Abnormal Activities)',
    bestFor: 'Stalking, Harassment, Trailing, and Abnormal Proximity Vectors',
    source: 'Official Research / Kaggle',
    sourceUrl: 'https://www.kaggle.com/search?q=extranom+anomaly+surveillance',
    type: 'Surveillance Video & Coordinate Sequences',
    samples: 1420,
    classes: 5,
    version: 'v2.0 (Active Inference)',
    status: 'Ready for Training',
    size: '18.4 GB',
    lastUpdated: 'Women Safety Benchmark'
  },
  {
    id: 'DS-UCF-CRIME',
    name: 'UCF-Crime Surveillance Anomaly Dataset',
    bestFor: 'CCTV Abnormal Activities, Abuse, Assault, Street Fighting, Normal Commute',
  ...
  {
    id: 'DS-RWF-2000',
    name: 'RWF-2000 (Real-World Violence / Fight Detection)',
    bestFor: 'Violent altercations, physical struggles vs non-violent baseline activity',
    source: 'Kaggle / PMC',
    sourceUrl: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC13039427/',
    type: '2,000 CCTV 30fps Video Clips',
    samples: 2000,
    classes: 2,
    version: 'v1.0 (Standard)',
    status: 'Ready for Training',
  ...
  },
  {
    ...
    bestFor: 'Fear, distress, sadness, anger, neutral (Supporting Affect Signal)',
    source: 'Kaggle + PMC',
    sourceUrl: 'https://www.kaggle.com/datasets/pankaj4321/fer-2013-facial-expression-dataset',
    type: 'Grayscale 48x48 Images & Sequences',
    samples: 35887,
    classes: 7,
    version: 'v1.0 (Standard)',
    status: 'Ready for Training',
