...
export const SIXTEEN_CCTV_FEEDS = [
  ...
  { id: 2, camId: 'CAM 02', name: '02 Main Junction', location: 'Signal Crossing East', womenDetected: 'Yes', threat: true, risk: 'MEDIUM', video: '/videos/cam_02.mp4', face: 'Alert', behavior: 'Rapid Approach Vector', interaction: 'Rapid Closing Distance', duration: '00:01:45', confidence: 86 },
  { id: 3, camId: 'CAM 03', name: '03 Railway Station', location: 'Platform 1 Waiting Bay', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_03.mp4', face: 'Neutral', behavior: 'Normal Transit', duration: '00:08:20', confidence: 97 },
  { id: 4, camId: 'CAM 04', name: '04 Market Area', location: 'Commercial Bazaar South', womenDetected: 'Yes', threat: true, risk: 'HIGH', video: '/videos/cam_04.mp4', face: 'Distress / Fear', behavior: 'Persistent Stalking Vector', interaction: 'Trailing Distance < 2m', duration: '00:02:18', confidence: 91 },
  { id: 5, camId: 'CAM 05', name: '05 College Campus', location: 'North Walkway Gate 2', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_05.mp4', face: 'Happy', behavior: 'Student Transit', duration: '00:05:30', confidence: 98 },
  { id: 6, camId: 'CAM 06', name: '06 Public Street', location: 'Sub-Lane 4 Residential', womenDetected: 'No', threat: false, risk: 'LOW', video: '/videos/cam_06.mp4', face: 'Neutral', behavior: 'Pedestrian Flow', duration: '00:03:10', confidence: 95 },
  { id: 7, camId: 'CAM 07', name: '07 Bus Stop', location: 'Kamaraj Nagar Shelter', womenDetected: 'Yes', threat: true, risk: 'HIGH', video: '/videos/cam_07.mp4', face: 'Distress', behavior: 'Loitering & Cornering', interaction: 'Hovering Trajectory', duration: '00:03:02', confidence: 89 },
  { id: 8, camId: 'CAM 08', name: '08 Hospital Zone', location: 'Emergency Bay Entrance', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_08.mp4', face: 'Tense', behavior: 'Medical Transit', duration: '00:06:14', confidence: 92 },
  { id: 9, camId: 'CAM 09', name: '09 Shopping Mall', location: 'Main Plaza Promenade', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_09.mp4', face: 'Happy', behavior: 'Public Shopping', duration: '00:07:45', confidence: 96 },
  { id: 10, camId: 'CAM 10', name: '10 Metro Station', location: 'Concourse Ticket Gate', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_10.mp4', face: 'Neutral', behavior: 'Passenger Entry', duration: '00:04:40', confidence: 97 },
  { id: 11, camId: 'CAM 11', name: '11 Auto Stand', location: 'Railway Feeder Stand', womenDetected: 'Yes', threat: true, risk: 'MEDIUM', video: '/videos/cam_11.mp4', face: 'Alert', behavior: 'Unusual Encircling', interaction: 'Repeated Pass-by', duration: '00:01:50', confidence: 84 },
  { id: 12, camId: 'CAM 12', name: '12 IT Park Road', location: 'Tech Zone Boulevard', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_12.mp4', face: 'Neutral', behavior: 'Corporate Transit', duration: '00:09:12', confidence: 98 },
  { id: 13, camId: 'CAM 13', name: '13 Sub-way Tunnel', location: 'Underpass Walkway North', womenDetected: 'Yes', threat: true, risk: 'CRITICAL', video: '/videos/cam_13.mp4', face: 'Panic / Fear', behavior: 'Aggressive Cornering', interaction: 'Perimeter Intrusion', duration: '00:00:58', confidence: 93 },
  { id: 14, camId: 'CAM 14', name: '14 Park Perimeter', location: 'Gandhi Park Jogging Bay', womenDetected: 'No', threat: false, risk: 'LOW', video: '/videos/cam_14.mp4', face: 'Neutral', behavior: 'Jogger Movement', duration: '00:04:15', confidence: 95 },
  { id: 15, camId: 'CAM 15', name: '15 School Zone', location: 'Main School Crosswalk', womenDetected: 'Yes', threat: false, risk: 'LOW', video: '/videos/cam_15.mp4', face: 'Neutral', behavior: 'Pedestrian Crossing', duration: '00:05:00', confidence: 99 },
  { id: 16, camId: 'CAM 16', name: '16 Bridge Underpass', location: 'Flyover Pillar 12 Dark Zone', womenDetected: 'Yes', threat: true, risk: 'HIGH', video: '/videos/cam_16.mp4', face: 'Distress', behavior: 'Following in Isolated Zone', interaction: 'Persistent Shadowing', duration: '00:02:40', confidence: 90 },
];
